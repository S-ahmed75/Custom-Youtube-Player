...
class AppDelegate: UIResponder, UIApplicationDelegate ,CAAnimationDelegate{
    ...
    func initiate() {
        ...
        navigationController.view.layer.mask?.contents = UIImage(named: "launchS.png")!.cgImage
        ...
        let finalBounds = NSValue(cgRect: CGRect(x: 0, y: 0, width: 100000, height: 6000))
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "youTube2")
